    ...
    <div class="login-warp">
      <header class="mint-header headNav" style="height:43.98px;line-height:43.98px">
        <div class="mint-header-button is-left">
          <button class="mint-button mint-button-normal">
            <span class="mint-buton-icon">
              <i class="iconfont icon-arrowleft" @click='shouye'>
        ...
        <div class="mint-header-button is-right">
          <div href style="color:inherit;font-size:14px" @click='zhuce'>
...
export default {
  data(){
        ...
        return{
          ...
          img2: require('../assets/img/logo.png'),
    ...
    methods:{
      zhuce(){this.$router.push("/register");},
      shouye(){ this.$router.push("/home");},
      submitForm(){
